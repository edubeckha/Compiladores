...
// typedef std::map<std::string, Funcao> FuncList; //Set of Functions
...
//         Funcao(Tipos::Tipo type, Kind kind, std::vector<ST::Symbol*> parametros, bool initialized) :
//             type(type), kind(kind), parametros(parametros), initialized(false) {  }
// };
