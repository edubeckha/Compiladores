...
%token T_NL T_PLUS T_TIMES  T_FINALEXP T_SUB T_DIVI T_IGUAL T_MAIOR T_MENOR
%token T_MAIORIGUAL T_MENORIGUAL T_UNIBOOL T_DIFERENTE T_PARA T_PARAF T_AND T_OR T_ARRA T_ARRAF
%token T_DINT T_DREAL T_DBOOL T_WHILE T_END T_DO T_IF T_THEN T_ELSE T_DEF 
%token T_COMMA T_ASSIGN
...
line    : T_NL { $$ = NULL; } /*nothing here to be used */
        ...
        |T_IF expr T_THEN lines T_END T_IF %prec "then" { $$ = new AST::Condicao($2, $4, NULL);} 
        |T_IF expr T_THEN lines T_ELSE lines T_END T_IF %prec "then" { $$ = new AST::Condicao($2, $4, $6);}  
